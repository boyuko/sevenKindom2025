...
template<> LIVELINKMVNPLUGIN_API UScriptStruct* StaticStruct<FRemappingRowHandle>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULiveLinkMvnRetargetAsset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULiveLinkMvnRetargetAsset_GetCustomRemappedBoneName, "GetCustomRemappedBoneName" }, // 4093204178
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics::ScriptStructInfo[] = {
		{ FRemappingRowHandle::StaticStruct, Z_Construct_UScriptStruct_FRemappingRowHandle_Statics::NewStructOps, TEXT("RemappingRowHandle"), &Z_Registration_Info_UScriptStruct_RemappingRowHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRemappingRowHandle), 615368410U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkMvnRetargetAsset, ULiveLinkMvnRetargetAsset::StaticClass, TEXT("ULiveLinkMvnRetargetAsset"), &Z_Registration_Info_UClass_ULiveLinkMvnRetargetAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkMvnRetargetAsset), 3624315471U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_964513719(TEXT("/Script/LiveLinkMvnPlugin"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LiveLinkMvnPlugin_Source_LiveLinkMvnPlugin_Public_LiveLinkMvnRetargetAsset_h_Statics::ScriptStructInfo),
		nullptr, 0);

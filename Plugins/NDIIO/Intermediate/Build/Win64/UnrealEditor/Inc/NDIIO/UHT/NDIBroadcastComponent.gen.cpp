...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UNDIBroadcastComponent_ChangeSourceName_Statics::NewProp_InSourceName = { "InSourceName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NDIBroadcastComponent_eventChangeSourceName_Parms, InSourceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNDIBroadcastComponent_ChangeSourceName_Statics::NewProp_InSourceName_MetaData), Z_Construct_UFunction_UNDIBroadcastComponent_ChangeSourceName_Statics::NewProp_InSourceName_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNDIBroadcastComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_ChangeBroadcastConfiguration, "ChangeBroadcastConfiguration" }, // 2832425539
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_ChangeBroadcastTexture, "ChangeBroadcastTexture" }, // 3098202270
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_ChangeSourceName, "ChangeSourceName" }, // 554655345
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_GetNumberOfConnections, "GetNumberOfConnections" }, // 3690700724
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_GetTallyInformation, "GetTallyInformation" }, // 1969278896
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_StartBroadcasting, "StartBroadcasting" }, // 3253292788
		{ &Z_Construct_UFunction_UNDIBroadcastComponent_StopBroadcasting, "StopBroadcasting" }, // 172973473
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNDIBroadcastComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_sevenKindom2025_Plugins_NDIIO_Source_Core_Public_Components_NDIBroadcastComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_sevenKindom2025_Plugins_NDIIO_Source_Core_Public_Components_NDIBroadcastComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNDIBroadcastComponent, UNDIBroadcastComponent::StaticClass, TEXT("UNDIBroadcastComponent"), &Z_Registration_Info_UClass_UNDIBroadcastComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNDIBroadcastComponent), 3608246389U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_sevenKindom2025_Plugins_NDIIO_Source_Core_Public_Components_NDIBroadcastComponent_h_3769055929(TEXT("/Script/NDIIO"),
		Z_CompiledInDeferFile_FID_sevenKindom2025_Plugins_NDIIO_Source_Core_Public_Components_NDIBroadcastComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_sevenKindom2025_Plugins_NDIIO_Source_Core_Public_Components_NDIBroadcastComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
